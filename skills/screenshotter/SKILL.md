---
name: screenshotter
description: "Use when the user wants native macOS Cmd+Shift+3 or Cmd+Shift+4 screenshots captured by pi through the local agent-screens CLI without copy/paste or drag/drop."
---
...
The agent-screens package provides `/screenshotter` commands backed by the local `agent-screens` CLI:
...
- Detected screenshots are prepared and optimized locally by `agent-screens`.
